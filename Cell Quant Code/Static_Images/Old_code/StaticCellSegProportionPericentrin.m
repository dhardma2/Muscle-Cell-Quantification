...
prompt = {'Pixel width (microns):','Day:','Position:','Enhancement factor:','image length:','Dilation factor:','% Pericentrin threshold:','File_Prefix:'};
dlgtitle = 'Input';
dims = [1 35];
%Myogenin threshold will change with fluorescence intensity
definput = {'0.1135','2','1','30','500','3','0.05','HiPSC'};
...
filename1=sprintf('%s-Pos%d-D%d-MTDNA.tif',pref,pos,D);
filename2=sprintf('%s-Pos%d-D%d-DNABW.tif',pref,pos,D);
filename3=sprintf('%s-Pos%d-D%d-DNA.tif',pref,pos,D);
filename4=sprintf('%s-Pos%d-D%d-MTDNABW.tif',pref,pos,D);
filename5=sprintf('%s-Pos%d-D%d-ActinBW.tif',pref,pos,D);
